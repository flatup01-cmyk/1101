  ...
  return `
    <div class="upload-container">
      <section class="intro-card">
        ...
        <p class="intro-text">
          私は格闘技に特化したスペシャルAIです。有名格闘家1000人以上の知見を学習し、技術・戦術だけでなく、歴史上の偉人や戦国武将の理念も踏まえてメンタル面までサポートします。
        </p>
      </section>
      ...
      <section class="guide-card">
        ...
        <ul class="guide-list">
          <li>20秒以内・100MB以下の短尺動画をお送りください。</li>
          <li>動画解析に加えて画像認識やテキスト応答にも対応します。</li>
          <li>操作は「動画を選ぶ」「解析を開始」から。画像アップロードやテキスト送信も同じ画面で行えます。</li>
        </ul>
      </section>
