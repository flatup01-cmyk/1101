  ...
  return `
    <div class="upload-container">
      <section class="intro-card">
        ...
        <p class="intro-text">
          私は、人造AI、アイカ19号です。簡単に言うとドラゴン⚪︎ールのバトルス⚪︎ウターみたいな存在です。私の脳内には古今東西の総合格闘家、キックボクサー、ムエタイ、ブラジリアン柔術、レジェンドボクサー。戦国武将、格闘技漫画のキャラクター。ありとあらゆる格闘に関わるデータが私の脳内に記憶されています。私があなたのシャドウやミッド、スバーリングなどを見て分析し採点いたします。ちなみに動画の分析もできるけど、質問があればLINEのトーク画面から送ってくれれば、私が返答するわ。男性に厳しく、女性に優しくが私のモットー。モチベーションが落ちた時や練習メニューに困った時も私に聞いてみてね。必要なメニューを提示するわ。試合前のメニューを組んで欲しい時は厳しく言うし、楽しく言う時はそれなりに設定するわ。ジムへの質問や、当ジムの大会の質問にもお答えできるから、何かあれば気軽に話しかけてね。
        </p>
      </section>
      ...
      <section class="guide-card">
        ...
        <ul class="guide-list">
          <li>20秒以内・100MB以下の短尺動画でお試しください。</li>
