  ...
  return `
    <div class="upload-container">
      <section class="intro-card">
        ...
        <p class="intro-text">
          私は、人造AI、アイカ19号です。簡単に言うとドラゴンボールのバトルスカウターみたいな存在です。私の脳内に、古今東西の総合格闘家、キックボクサー、ムエタイ、ブラジリアン柔術、ボクサーレジェンド。戦国武将、漫画のキャラクター。ありとあらゆる格闘に関わるデータが私の脳内に記憶されています。私があなたのシャドウやミッド、バーリングなどを見て分析し採点いたします。
        </p>
      </section>
