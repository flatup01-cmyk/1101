  ...
  return `
    <div class="upload-container">
      <section class="intro-card">
        ...
        <p class="intro-text">
          私は、人造AI、アイカ19号です。簡単に言うとドラゴン⚪︎ールのバトルス⚪︎ウターみたいな存在です。私の脳内には古今東西の総合格闘家、キックボクサー、ムエタイ、ブラジリアン柔術、レジェンドボクサー。戦国武将、格闘技漫画のキャラクター。ありとあらゆる格闘に関わるデータが私の脳内に記憶されています。私があなたのシャドウやミッド、スバーリングなどを見て分析し採点いたします。
        </p>
      </section>
