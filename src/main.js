  ...
  return `
    <div class="upload-container">
      <section class="intro-card">
        ...
        <p class="intro-text">
          私は人造AI、アイカ19号よ。ドラゴン⚪︎ールのバトルス⚪︎ウターみたいな存在で、古今東西の格闘家データが脳内に詰め込まれているわ。あなたの動画やシャドウを見て分析・採点するわ。男性に厳しく、女性に優しくが私のモットー。モチベーションが落ちた時や練習メニューに困った時は、LINEで気軽に聞いてね。試合前は厳しく、普段はそれなりにメニューを組むわ。ジムや大会の質問にもお答えできるから、何かあれば話しかけてね。
        </p>
      </section>
